...
def test_acted_together_04():
    # Simple test, actor2 not in db
    actor1 = 1532
    actor2 = 9873
    assert not lab.acted_together(db_tiny, actor1, actor2)
    
def test_acted_together_05():
    # Simple test, actor1 not in db
    actor1 = 6743
    actor2 = 1640
    assert not lab.acted_together(db_tiny, actor1, actor2)
    
def test_acted_together_06():
    # Simple test, actor1 and actor2 not in db
    actor1 = 1111
    actor2 = 2222
    assert not lab.acted_together(db_tiny, actor1, actor2)
...
def test_bacon_number_05():
    ...
    second_result = lab.actors_with_bacon_number(db_tiny, n)
    assert isinstance(second_result, set)
    assert second_result == expected
    
def test_bacon_number_06():
...
def test_bacon_path_07():
    # Bacon path, tiny database, length of 2 (4 actors, 3 movies)
    actor_id = 1640
    len_expected = 2
