...
def test_file():
    compare_outputs(*_test_file("small_test1.snek", 56))

def test_file_2():
    compare_outputs(*_test_file("small_test2.snek", 57))

def test_file_3():
    compare_outputs(*_test_file("small_test3.snek", 58))

def test_file_4():
    compare_outputs(*_test_file("small_test4.snek", 59))

def test_file_5():
    compare_outputs(*_test_file("small_test5.snek", 60))
